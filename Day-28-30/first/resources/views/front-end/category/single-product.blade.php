                        ...
                        <div class="col-md-4 product-grid">
                            <div id="owl-demo" class="owl-carousel">
                                ...
                                <div class="item">
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="{{ route('single-product') }}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r4.jpg" alt=""></a>
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="{{ route('single-product') }}">Lorem ipsum dolor </a></h6>
                                            <div class="block">
                                    ...
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="{{ route('single-product') }}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r5.jpg" alt=""></a>
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="{{ route('single-product') }}">Duis aute irure </a></h6>
                                            <div class="block">
